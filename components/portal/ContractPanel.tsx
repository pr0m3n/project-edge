...
function sections(project: Project) {
  ...
  return [
    ...
    ["3", "Díj és fizetés", managed
      ...
      : `Vállalási díj: ${price}.${project.coupon_code && project.base_offer_price ? ` Eredeti ajánlati ár: ${formatPrice(project.base_offer_price, project.offer_currency || "Ft")}; alkalmazott kupon: ${project.coupon_code}; kedvezmény: ${formatPrice(project.coupon_discount_amount, project.offer_currency || "Ft")}.` : ""} Foglaló: ${formatPrice(project.deposit_amount, project.offer_currency || "Ft")}; a fennmaradó díj jóváhagyás után, a teljes átadás előtt esedékes. ${PRICE_TAX_NOTE}`],
