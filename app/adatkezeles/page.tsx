...
export const metadata: Metadata = { title: "Adatkezelési tájékoztató | ProjectEdge", description: "A ProjectEdge GDPR szerinti adatkezelési tájékoztatója." };
...
export default function PrivacyPage() {
  return <main className="site-shell light-page"><SiteNav />
    ...
    <section className="legal-prose">
      ...
      <h2>6. Sütik és automatizált döntés</h2><p>A belépéshez és biztonsághoz szükséges sütik hozzájárulás nélkül használhatók. Nem végzünk joghatással járó automatizált döntéshozatalt vagy profilalkotást. Nem kötelező adatot megadni, de a szerződéshez szükséges adatok hiányában a szolgáltatás nem teljesíthető.</p>
